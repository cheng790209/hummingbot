...
from hummingbot.connector.exchange.max import max_constants as CONSTANTS
from hummingbot.connector.time_synchronizer import TimeSynchronizer
from hummingbot.core.web_assistant.auth import AuthBase
from hummingbot.core.web_assistant.connections.data_types import RESTRequest, WSRequest


class MaxAuth(AuthBase):
    ...
    async def ws_authenticate(self, request: WSRequest) -> WSRequest:
        """
        This method is intended to configure a websocket request to be authenticated. Max does not use this
        functionality
        """
    ...
    def authentication_headers(self, request: RESTRequest) -> Dict[str, Any]:
        ...
        passphrase = base64.b64encode(
            hmac.new(
                ...
                hashlib.sha256).digest())
        header["X-MAX-PAYLOAD"] = str(signature, "utf-8")
        header["X-MAX-SIGNATURE"] = str(passphrase, "utf-8")
